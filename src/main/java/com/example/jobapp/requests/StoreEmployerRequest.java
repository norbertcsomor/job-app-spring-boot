...
/**
 * A munkaadó létrehozásának kérését leíró validációs változó.
 * 
...
@NoArgsConstructor
@AllArgsConstructor
public class StoreEmployerRequest {
    ...
    @Size(min = 10, message = "A jelszónak min. 10 karakterből kell állnia!")
    private String password;
    @NotBlank(message = "A jelszó megerősítése mező kitöltése kötelező!")
    @Size(min = 10, message = "A jelszó megerősítésének min. 10 karakterből kell állnia!")
